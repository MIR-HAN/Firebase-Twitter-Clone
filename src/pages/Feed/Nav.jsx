...
md:text-xl p-3 cursor-pointer rounded-lg transition
 hover:bg-[#505050b7] max-md:justify-center' key={key}>
{i.icon}
...
{!user ? (
  ...
  <div className='flex flex-col gap-5 '> 
    ...
    <button onClick={()=> signOut(auth)} className='flex justify-center gap-2 p-1 items-center
    bg-zinc-700 rounded text-2xl md:text-[15px] transition hover:bg-zinc-900 
    ' >
       <BiDoorOpen/>
